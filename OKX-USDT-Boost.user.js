...
(function() {
    ...
    function mountCalculatorPanel(panel) {
        ...
        if (detailTarget && isCompactPanelAutoOpened) {
            isCompactPanelOpen = false;
            isCompactPanelAutoOpened = false;
            isCompactPanelDismissed = false;
        }
    ...
    function createUI() {
        ...
        if (!findCalculatorMountTarget() && !findCompactChartElements()) {
            watchCalculatorMountTarget();
            return;
        }
